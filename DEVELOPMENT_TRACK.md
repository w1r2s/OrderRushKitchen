...
Фокус:
- начать M6: ввести level-progression контур поверх текущего order lifecycle
- зафиксировать контракт перехода между уровнями (условие завершения, разблокировка)
- подготовить минимальный runtime UI/состояние текущего уровня без полировки
- не трогать закрытый поток M5, кроме багфиксов
## Журнал решений
