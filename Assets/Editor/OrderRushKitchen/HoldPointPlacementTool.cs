...
namespace OrderRushKitchen.EditorTools
{
    #if UNITY_EDITOR
    ...
    public static class HoldPointPlacementTool
    {
        ...
        {
            Transform selected = EditorSelection.activeTransform;
            ...
            EditorSelection.activeTransform = holdPoint;
        }
        ...
        {
            return EditorSelection.activeTransform != null;
        }
    }
    #endif
